<template>
  ...
  >
    ...
    <nav
      class="flex flex-wrap gap-[6px] relative"
      aria-label="Main Navigation of The Training Hub"
    >
      <NuxtLink
